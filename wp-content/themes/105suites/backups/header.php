		...
		<div id="sliders-container">
			...
			if ( is_search() ) {
				...
				?>
					<div class="Languages">
						<ul>
							<li><a href="/105suite/?lang=en" class="flag flag-us"></a></li>
							<li class="hide"><a href="/105suite/?lang=fr" class="flag flag-france"></a></li>
							<li class="hide"><a href="/105suite/?lang=es" class="flag flag-spain"></a></li>
						</ul>
					</div>				
...
<!-- 										<span>
								...
								<div class="form-group">
									...
									<button type="submit" class="btn btn-lg btn-primary btn-booking">Find</button>
								</div>
							</form>
						</div>
					<?php endif; ?>
