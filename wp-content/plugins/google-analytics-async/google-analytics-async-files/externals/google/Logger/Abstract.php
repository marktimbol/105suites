 ...
 */
abstract class GAPGoogle_Logger_Abstract
{
  /**
   * Default log format
   */
  ...
  /**
   * @param GAPGoogle_Client $client  The current Google client
   */
  public function __construct(GAPGoogle_Client $client)
  {
    $this->setLevel(
        $client->getClassConfig('GAPGoogle_Logger_Abstract', 'level')
    );
   ...
   * @throws GAPGoogle_Logger_Exception If $level is invalid
   */
