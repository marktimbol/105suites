 ...
 * with the `GAPGoogle_Logger_Psr::setLogger()` method.
 */
class GAPGoogle_Logger_Psr extends GAPGoogle_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(GAPGoogle_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
