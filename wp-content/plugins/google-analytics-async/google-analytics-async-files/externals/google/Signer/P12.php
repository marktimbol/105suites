 ...
 */
class GAPGoogle_Signer_P12 extends GAPGoogle_Signer_Abstract
{
  ...
  public function __construct($p12, $password)
  {
    ...
    if (!$this->privateKey) {
      throw new GAPGoogle_Auth_Exception("Unable to load private key");
    }
  }
  ...
  public function sign($data)
  {
    ...
    if (!openssl_sign($data, $signature, $this->privateKey, $hash)) {
      throw new GAPGoogle_Auth_Exception("Unable to sign data");
    }
    return $signature;
  }
}