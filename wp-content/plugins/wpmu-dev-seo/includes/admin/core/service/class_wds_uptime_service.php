...
class WDS_Uptime_Service extends WDS_Service {

	public function get_known_verbs () { return array('day'); }

	public function is_cacheable_verb ($verb) { return true; }
	...
	public function get_cache_expiry ($expiry=false) {
		$expiry =  WDS_Service::ERR_CACHE_EXPIRY === $expiry
			? $expiry
			: DAY_IN_SECONDS
		;
		return $expiry;
